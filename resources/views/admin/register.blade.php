...
<div class="pages section">
    <div class="container">
        ...
        <div class="register">
            <div class="row">
                <form class="col s12" action="http://api.1911.com/Admin/goodsregdo" method="post">
                    <div class="input-field">
                        <input type="text" class="validate" placeholder="NAME" name="reg_name" required>
                    </div>
                    <div class="input-field">
                        <input type="email" placeholder="EMAIL" name="reg_email" class="validate" required>
                    </div>
                    <div class="input-field">
                        <input type="password" placeholder="PASSWORD" name="reg_pwd" class="validate" required>
                    </div>
